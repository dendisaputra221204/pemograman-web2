          ...
          <div class="modal-body">
            <form id="formTambah" action="/index.php/simpan" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="pengarang" id="pengarang" class="form-control" require>
                  </div>
                  <div class="mb-3">
                    <label for="penerbit">Penerbit</label>
                    <input type="text" name="penerbit" id="penerbit" class="form-control" require>
                  </div>
                  <div class="mb-3">
                    <label for="tahun">Tahun</label>
                    <input type="text" name="tahun" id="tahun" class="form-control" require>
                  </div>
            </form>
          </div>
